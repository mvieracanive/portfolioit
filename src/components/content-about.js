...
export class About extends React.Component{
    ...
    render(){
        return <div className='About ContentWithSmallMargin'>
                <img src={aboutInfo.photoProfile} className='Photo' alt="My photo"></img>
                <p>                    
                    {this.state.about}
                </p> 
    ...
    componentDidMount(){
        ...
        for(let i=0; i<aboutInfo.certificates.length; i++){
            ...
            image.addEventListener('transitionend', function() {
                ...
                const flag = rect.width >= 70; //Size may viry but this limit seams appropriate for differencing between normal and scaled
    ...
    for(let i=0; i < props.certificates.length; i++){
        list.push(
            <div key={i} className='col-lg-4 col-md-6 col-sm-12'>
                <img alt="My postgraduate qualification" id={'imgcert'+i} src={props.certificates[i].cert} className='CertificateImg'></img>
...
function Awards(props){
    ...
    for(let i=0; i < props.awards.length; i++){
        list.push(
            <div key={i} className='col-lg-4 col-md-6 col-sm-12'>
                <img alt="My awards" id={'imgawr'+i} src={props.awards[i].cert} className='CertificateImg'></img>
